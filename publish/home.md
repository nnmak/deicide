...
```leaflet  
id: WorldMap ### Must be unique with no spaces  
image: [[WorldMap.jpg]] ### Link to the map image file  
...
lat: 490 ### To center the map, make this half of the map width.  
long: 1550 ### To center the map, make this half of the map height.  
